        ...
        <div class="row ">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4  ">
                <ul class="list-unstyled contact-links">
                    ...
                    <li><i class="fa fa-phone" aria-hidden="true"></i><a href="tel:+19494328383">+194 94 32 83 83 </a>
                    </li>
                    <li><i class="fa fa-whatsapp" aria-hidden="true"></i><a href="https://wa/me/+19494328383"
                            target="_blank">+194 94 32 83 83</a></li>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 text-center ">
                ...
                <p class="txt-footer" style="margin-top: 12px;">A professional group focused on
                    <br> creative and results-driven solutions.
                </p>
                <p class="txt-footer" style="margin-top: 5px;"> 24 / 7 </p>
