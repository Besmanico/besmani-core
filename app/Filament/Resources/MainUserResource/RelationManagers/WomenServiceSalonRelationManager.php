...
class WomenServiceSalonRelationManager extends RelationManager
{
    protected static string $relationship = 'WomenServiceSalon';

    public static function getTitle(Model $ownerRecord, string $pageClass): string
    {
        $count = $ownerRecord->WomenServiceSalon()->count();
        return "Women Service  ({$count})";
    }
