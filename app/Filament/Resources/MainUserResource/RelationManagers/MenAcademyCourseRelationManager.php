...
class MenAcademyCourseRelationManager extends RelationManager
{
    protected static string $relationship = 'MenAcademyCourse';
    public static function getTitle(Model $ownerRecord, string $pageClass): string
    {
        $count = $ownerRecord->MenAcademyCourse()->count();
        return "Men Course  ({$count})";
    }
