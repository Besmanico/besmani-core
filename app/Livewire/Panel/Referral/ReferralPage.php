...
{  
    ...
    public function createReferral(): void
    {
        ...
        DB::transaction(function () use ($user, $receiverUserId, $receiverBusinessId, $referrerBusinessId, $customer): void {
    ...
    public function render()
    {
        ...
        $selectedReferral = $this->selectedReferralId
            ? $this->findVisibleReferral($this->selectedReferralId)->load(['referrerUser', 'receiverUser', 'service'])
            : null;
        ...
        return view('livewire.panel.referral.referral-page', [
            'referrals' => $referrals->with(['referrerUser', 'receiverUser', 'service'])->latest()->limit(50)->get(),
            'counts' => [
